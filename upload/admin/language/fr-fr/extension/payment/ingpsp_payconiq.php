 ...
 */
$_['heading_title'] = 'ING PSP: Payconiq';
$_['text_ingpsp_payconiq'] = '<img src="view/image/payment/ingpsp.png" alt="ING PSP" title="ING PSP" />';
...
$_['text_settings_saved'] = 'ING PSP: Paramètres Payconiq mis a jour!';
$_['text_edit_ing'] = 'Modifier ING PSP: Paramètres Payconiq';
$_['text_yes'] = 'Oui';
$_['text_no'] = 'Non';
...
$_['info_plugin_not_configured'] = 'ING PSP: Plugin Payconiq est pas configuré.';
$_['info_help_ip_filter'] = 'Si cette champs est rempli, uniquement pour ces adresses IP le mode de paiement sera affiché. (Par Ex: 128.0.0.1, 255.255.255.255)';
$_['entry_ip_filter'] = 'le filtrage IP:';
$_['entry_test_api_key'] = 'clé API de Test:';
$_['info_help_test_api_key'] = 'Si entré, cette clé API sera utilisée uniquement à des test.';