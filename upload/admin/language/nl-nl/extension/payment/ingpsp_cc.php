 ...
 */
$_['heading_title'] = 'ING PSP: Creditcard';
...
$_['text_settings_saved'] = 'ING PSP: Credit Card instellingen bijgewerkt!';
$_['text_edit_ing'] = 'Bewerken ING PSP: Credit Card instellingen';
$_['text_yes'] = 'Ja';
$_['text_no'] = 'Nee';
 ...
 * Error messages
 */
$_['error_missing_api_key'] = 'ING PSP API Key is verplicht!';
...
$_['info_plugin_not_configured'] = 'ING PSP: Credit Card plugin is niet ingesteld.';
$_['info_help_ip_filter'] = 'Indien ingevoerd, alleen voor die IPs, wordt de betaalmethode weergegeven. (Bijvoorbeeld: 128.0.0.1, 255.255.255.255)';
